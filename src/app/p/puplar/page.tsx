...
const Puplar = () => {
  ...
  const descriptionProps = {
    projectName: "Puplar",
    brief:
      "Refresh brand and product UI for a multi-currency savings & payments experience, including virtual cards and FX flows.",
    overview:
      "Puplar offers crypto and fiat funding, multi-currency accounts and virtual dollar cards. Users struggled with trust and clarity on large cross-border transactions and funding flows.",
    ...
    androidDownloadUrl:
      "https://play.google.com/store/apps/details?id=com.a.puplar",
  };
  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row bg-[#f6f6f6]">
      ...
      <aside className="hidden md:block w-[390px] shrink-0 bg-white border-l border-gray-200 z-40 h-screen sticky top-0 overflow-y-auto">
        <ProjectDesc {...descriptionProps} />
      </aside>
    </div>
  );
